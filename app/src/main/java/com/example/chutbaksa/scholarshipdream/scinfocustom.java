...
public class scinfocustom extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.activity_sccustom, container, false);

        informedUrl = new restURLmaker().makeUrl(view.getContext());
        //informedUrl = "http://52.68.98.173:8080/JanghakDream/janghak/select/school/hanyang";
